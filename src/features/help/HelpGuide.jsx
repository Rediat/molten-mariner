...
import {
    ...
    ChevronDown, ChevronUp, Book, Lightbulb, Hash, ArrowRight
} from 'lucide-react';
...
const HelpSection = ({ title, icon: Icon, children, defaultOpen = false }) => {
    ...
    return (
        <div className="bg-neutral-800/50 rounded-xl border border-neutral-700/50 overflow-hidden transition-all duration-300">
            <button
...
const HelpGuide = () => {
    return (
        <div className="flex flex-col h-full text-left">
            {/* Header */}
            <div className="mb-4">
                <h1 className="text-2xl font-bold bg-gradient-to-r from-white to-neutral-400 bg-clip-text text-transparent flex items-center gap-2">
                    <HelpCircle className="w-6 h-6 text-primary-500" />
                    Help Guide
                </h1>
                <p className="text-neutral-500 text-sm">Complete user documentation for all calculators</p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-3 pr-1 scrollbar-hide">
                ...
                {/* Getting Started */}
                <HelpSection title="Getting Started" icon={Book} defaultOpen={true}>
                    <p>
                ...
                {/* TVM Calculator */}
                <HelpSection title="TVM Calculator" icon={Calculator}>
                    <p>
                ...
                {/* Goal Planner */}
                <HelpSection title="Goal Planner" icon={Target}>
                    <p>
                ...
                {/* Loan Calculator */}
                <HelpSection title="Loan Calculator" icon={DollarSign}>
                    <p>
                ...
                <HelpSection title="Cash Flow Calculator" icon={Activity}>
                    <p>
                ...
                {/* Bond Calculator */}
                <HelpSection title="Bond Calculator" icon={FileText}>
                    <p>
                ...
                {/* Rate Converter */}
                <HelpSection title="Rate Converter" icon={Percent}>
                    <p>
                ...
                {/* Common Concepts */}
                <HelpSection title="Financial Concepts" icon={Lightbulb}>
                ...
                {/* Tips & Best Practices */}
                <HelpSection title="Tips & Best Practices" icon={Lightbulb}>
