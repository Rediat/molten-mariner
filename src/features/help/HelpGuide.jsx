                        ...
                        <li className="flex gap-2">
                            ...
                            <div>
                                ...
                                <ul className="list-disc pl-5 mt-1 space-y-1 text-neutral-400 text-[11px]">
                                    ...
                                    <li><strong>Deposit Interest & Tax Options:</strong> When Time Deposits is selected, you can customize the interest structure. Toggle between <strong>Simple</strong> and <strong>Compounding</strong> interest, configure <strong>Compounds</strong> frequency (from At Maturity to Daily), and specify a <strong>Deduction (%)</strong> rate.</li>
            ...
            >
                ...
                <div className="pt-2">
                    ...
                    <FieldList fields={[
                        ...
                        { name: 'Brokerage', description: 'Calculates capital market brokerage commissions and statutory charges (VAT, ESX exchange, and ECMA regulatory fees) based on actual CBE Capital Investment Bank S.C. transactions. Other Investment banks and Brokers may have different rates. Based on current 2026 rates, they are following the same payment percentages for each category of payment. Note: The rates for each category of payment are as follows: Buy/Sale of Shares(0.5%), Subscription of new share(0.5%), Subscription of Treasury Bill(0.1%). The "Fixed Income" security type covers corporate bonds, government bonds traded on the secondary market, debentures, sukuk, and other debt securities listed or traded on the ESX. This is distinct from the "Treasury Bill" type, which applies only to primary market T-Bill subscriptions through NBE auctions.' }
                    ]} />
                </div>
